                ...
                <div class="flex w-full max-w-screen-lg">
                                ...
                                <div class="p-4">
                                    <div>
                                        ...
                                        <p class="text-center mb-4">
                                            <input type="text" v-model="item.total_price" :disabled="item.temp.is_detail" @keypress="[numberInput($event)]" @input="addSeparator($event, item, 'total_price')" :class="item.temp.is_detail ? 'disabled' : ''" class="price-input mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm border-gray-300 rounded-md" placeholder="xxx">
                                        </p>
                                    </div>
                                    <div>
                                        <p>Diskon Voucher</p>
                    ...
                    <div class="w-1/4 p-4 bg-white max-h-fit m-16">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" v-model="transaction.total_discount" placeholder="xxx" @keypress="[numberInput($event)]" @input="addSeparator($event, transaction, 'total_discount')" name="total-price-input" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
